	...
	)
{
	...
	$newRelease[] = ['All-New Wolverine #7' => '3.99'];
	$newRelease[] = ['Captain America Omnibus Volume 1 HC (New Printing)' => '125.00'];
	$newRelease[] = ['Amazing Spider-Man #11' => '3.99'];
	$newRelease[] = ['Daredevil #6 (David Lopez Story Thus Far Variant Cover)' => 'AR'];
	$newRelease[] = ['Doctor Strange #7 (Chris Bachalo Regular Cover)' => '3.99'];
	$newRelease[] = ['Doctor Strange Last Days Of Magic #1 (Shane Davis Variant Cover)' => 'AR'];
	$newRelease[] = ['Doctor Strange Volume 1 The Way Of The Weird HC (Premiere Edition)' => '$24.99'];
	$newRelease[] = ['International Iron Man #2 (Alex Maleev Regular Cover)' => '3.99'];
	$newRelease[] = ['Ms. Marvel #6 (David Lopez Regular Cover)' => '3.99'];
	$newRelease[] = ['Spidey #5' => '3.99'];
	$newRelease[] = ['Squadron Supreme #6 (Alex Garner Regular Cover)' => '3.99'];
	$newRelease[] = ['Ultimates #6 (Christian Ward Variant Cover)' => 'AR'];
	$newRelease[] = ['Ultimates #6 (Kenneth Rocafort Regular Cover)' => ' AR'];
	$newRelease[] = ['Unbeatable Squirrel Girl #7 (Colleen Doran Classic Variant Cover)' => '3.99'];
	$newRelease[] = ['X-Men Worst X-Man Ever #3 (Of 5)' => '3.99'];
	$newRelease[] = ['Year Of Marvels The Amazing #1' => '4.99'];
...
/*
		$step = 0;
		foreach($newRelease[$step] as $comicName => $comicPrice){
			echo $comicName . ' - ' . $comicPrice .  ' (ea.) <input type="number" name="' . $comicName . '" value="' . $_POST[$comicName]. '" >
		<br /><br />';
...
foreach ($a as $k => $v) {
		...
		//Comic A <input type="number" name="comic-A" value="' . $_POST['comic-A']. '" >
		//<br /><br />
