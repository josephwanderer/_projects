...
# 'action' can be read  ($_POST or $_GET) with $_REQUEST
...
{//check 'act' for type of process
	case "submitted":  // end deets
		...
		$myName = strip_tags($_POST['YourName']); #sanitize data
		echo '<p align="center">Your name is <b>' . $myName . '</b>!</p>';
	
		showName();
		echo showForm($myState);
		break;
...
function showForm($myState) {# shows form so user can enter their name.  Initial scenario
	return '
		...
		<table>
			...
			<tr>
				<td align="center" colspan="2">
					<input type="submit" value="Please Enter Your Name">
