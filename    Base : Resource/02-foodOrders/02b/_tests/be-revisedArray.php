	...
	)
{
	...
	$newRelease = [
		...
		'Doctor Strange Last Days Of Magic #1 (Shane Davis Variant Cover)' => 'AR',
		'Doctor Strange Volume 1 The Way Of The Weird HC (Premiere Edition)' => '$24.99',
		'International Iron Man #2 (Alex Maleev Regular Cover)' => '3.99',
		'Ms. Marvel #6 (David Lopez Regular Cover)' => '3.99',
		'Spidey #5' => '3.99',
		'Squadron Supreme #6 (Alex Garner Regular Cover)' => '3.99',
		'Ultimates #6 (Christian Ward Variant Cover)' => 'AR',
		'Ultimates #6 (Kenneth Rocafort Regular Cover)' => ' AR',
		'Unbeatable Squirrel Girl #7 (Colleen Doran Classic Variant Cover)' => '3.99',
		'X-Men Worst X-Man Ever #3 (Of 5)' => '3.99',
		'Year Of Marvels The Amazing #1' => '4.99',
	];
